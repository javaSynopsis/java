...
- [кортежи, Tuples в js (они же используются как immutabable структуры данных)](#кортежи-tuples-в-js-они-же-используются-как-immutabable-структуры-данных)
...
# кортежи, Tuples в js (они же используются как immutabable структуры данных)
